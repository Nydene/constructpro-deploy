...
class Project(models.Model):
    ...
    # Added to match consolidated_full & populate_ids logic
    client_information_id = models.IntegerField(db_column='client_information_id', blank=True, null=True)
    project_status_id = models.IntegerField(db_column='project_status_id', blank=True, null=True)
    amount = models.DecimalField(max_digits=15, decimal_places=2, default=0)
    estimated_expenses = models.DecimalField(max_digits=15, decimal_places=2, default=0)
    created_by_id = models.IntegerField(db_column='created_by_id', blank=True, null=True)
